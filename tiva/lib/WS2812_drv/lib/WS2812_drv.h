...
#define WS2812_SPI_BYTE_PER_LED WS2812_SPI_BYTE_PER_CLR * 3
  ...
  //
  // This function take a 1 byte color value and a location in the SPI data
  // array and write the appropriate values in the data array to represent that
  // color on the SPI line.  This function assumes the SPIData array has enough
  // memory allocated such that the translated color value will not overflow the
  // data array.
  //
  // @input pui8SPIData is the location in the SPI array of where the color
  // value
  ...
  //
  // This function take a 1 byte green color value and a location in the SPI
  // data array and write the appropriate values in the data array to represent
  // that color on the SPI line.  This function is used when the offset of the
  // WSG LED in the SPI buffer is known, but the number of bits from the LED
  // start location to where the "green" bits begins is unknown. This function
  // assumes the SPIData array has enough memory allocated such that the
  // translated color value will not overflow the data array.
  //
  ...
  //
  //*****************************************************************************
  inline void WSGtoSPI(uint8_t *pi8SPIData, uint8_t ui8Color)
  {
  ...
  // array and write the appropriate values in the data array to represent that
  // color on the SPI line.  This function is used when the offset of the WSG
  // LED in the SPI buffer is known, but the number of bits from the LED start
  // location to where the "red" bits begins is unknown. This function assumes
  // the SPIData array has enough memory allocated such that the translated
  // color value will not overflow the data array.
  //
  // @input pui8SPIData is the location in the SPI array where the LED whose
  ...
  //
  //*****************************************************************************
  inline void WSRtoSPI(uint8_t *pi8SPIData, uint8_t ui8Color)
  {
  ...
  //
  //*****************************************************************************
  inline void WSBtoSPI(uint8_t *pi8SPIData, uint8_t ui8Color)
  {
  ...
  // color value to the bits needed on the SPI array to represent that color,
  // and writes those bits to the proper location in the SPI data array.
  //
  ...
  //
  //*****************************************************************************
  inline void WSSetLEDGreen(uint8_t *pi8SPILEDs, uint16_t ui16LED,
                            uint8_t ui8Color)
  {
    WStoSPI(pi8SPILEDs + (3 * WS2812_SPI_BIT_WIDTH * ui16LED) +
                (WS2812_SPI_BIT_WIDTH * WS2812_GREEN_OFFS),
            ui8Color);
  }
  ...
  //
  //*****************************************************************************
  inline void WSSetLEDRed(uint8_t *pi8SPILEDs, uint16_t ui16LED,
                          uint8_t ui8Color)
  {
    WStoSPI(pi8SPILEDs + (3 * WS2812_SPI_BIT_WIDTH * ui16LED) +
                (WS2812_SPI_BIT_WIDTH * WS2812_RED_OFFS),
            ui8Color);
  }
  ...
  //
  //*****************************************************************************
  inline void WSSetLEDBlue(uint8_t *pi8SPILEDs, uint16_t ui16LED,
                           uint8_t ui8Color)
  {
    WStoSPI(pi8SPILEDs + (3 * WS2812_SPI_BIT_WIDTH * ui16LED) +
                (WS2812_SPI_BIT_WIDTH * WS2812_BLUE_OFFS),
            ui8Color);
  }
