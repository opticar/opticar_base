...
void WSGRBtoSPI(uint8_t *pi8SPIData, uint8_t ui8Green, uint8_t ui8Red,
                uint8_t ui8Blue)
{
...
{
  WStoSPI(pi8SPILEDs +
              (WS2812_SPI_BYTE_PER_CLR * WS2812_SPI_BIT_WIDTH * ui16LED) +
...
void WSArrayInit(uint8_t *pi8SPIData, uint16_t ui16Len)
{
  int i;
