...
#define portPeriphID4Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFD0))
#define portPeriphID5Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFD4))
#define portPeriphID6Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFD8))
#define portPeriphID7Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFDC))
#define portPeriphID0Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFE0))
#define portPeriphID1Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFE4))
#define portPeriphID2Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFE8))
#define portPeriphID3Register(P)                                               \
  ((volatile uint32_t *)(port_to_base[P] + 0xFEC))
